...
mixin _$ContactListState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Contacts> contacts) data,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Contacts> contacts)? data,
...
class _$_ContactListStateData implements _ContactListStateData {
  _$_ContactListStateData({required final List<Contacts> contacts})
      : _contacts = contacts;
...
abstract class _ContactListStateData implements ContactListState {
  factory _ContactListStateData({required final List<Contacts> contacts}) =
...
class _$_ContactListStateError implements _ContactListStateError {
  _$_ContactListStateError({required this.errorMessage});
  ...
  @override
  String toString() {
    return 'ContactListState.error(errorMessage: $errorMessage)';
  }
...
abstract class _ContactListStateError implements ContactListState {
  factory _ContactListStateError({required final String errorMessage}) =
